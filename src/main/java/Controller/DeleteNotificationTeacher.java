 ...
 * @author tramy
 */
public class DeleteNotificationTeacher extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.deleteNoti(notificationid);
            response.sendRedirect("teacherNotificationHistory");
        } catch (SQLException ex) {
            Logger.getLogger(DeleteNotification.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
