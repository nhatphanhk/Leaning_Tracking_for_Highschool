...
<html lang="en">
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "/learning-tracking/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "/learning-tracking/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "/learning-tracking/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
