                    ...
                    <form action="sendNotificationFromTeacher" method="post">
                        <div class="send-notification mx-4">
                            <div class="mb-3 d-flex mt-4">
                                ...
                                <p name="title" class="form-control w-75 noti-select">${detailTeacherNoti.title}</p>
                            </div>
                            <div class="mb-3 d-flex mt-4">
                                <label class="me-4">Đến:</label>
                                <p name="classname" class="w-75 noti-select" style="color: black;">${detailTeacherNoti.classname}</p>
                            </div>
                            <div class="mb-3">
